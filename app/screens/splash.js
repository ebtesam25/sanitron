...
export default class Splash extends React.Component  {
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:30,marginTop:'20%', textAlign:'center', color:'#364f6b', fontFamily:'FuturaH'}}>Sanitron</Text>
      <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#6C63FF', fontFamily:'FuturaL', marginTop:'2.5%', width:'70%',alignSelf:'center'}}>A smart sanitization system </Text>
